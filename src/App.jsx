...
function ProofCard({ item, index, onOpen }) {
  ...
  return (
    <div className="card proof-card premium-card">
      <button
        type="button"
        className={`proof-media-button ${canPreview ? "" : "is-disabled"}`}
      ...
      >
        {!imgError ? (
          <>
            ...
            />
            <span className="proof-image-sheen" />
            <span className="proof-image-badge">
              <Expand size={14} />
              Click to expand
            </span>
          </>
    ...
    <div className="site-shell premium-theme">
      ...
      <AnimatePresence>
        {activeProof ? (
          ...
          >
            <motion.div
              className="proof-lightbox-shell"
            ...
            >
              ...
              <div className="proof-lightbox-media">
                <img
                  src={activeProof.src}
              ...
              <div className="proof-lightbox-panel">
                <span className="badge badge-soft">Proof / results</span>
                <p className="proof-lightbox-count">
                  {String(activeProofIndex + 1).padStart(2, "0")} /{" "}
                  {String(proofImages.length).padStart(2, "0")}
                </p>
                <h3>{activeProof.title}</h3>
                <p>{activeProof.text}</p>

                <div className="proof-lightbox-actions">
                  <button
                    type="button"
                    className="btn btn-outline proof-nav-btn"
                ...
                <p className="proof-lightbox-hint">
